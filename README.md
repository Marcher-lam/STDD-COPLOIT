...
- **38 Skills + 12 Agent Roles** — Complete workflow coverage
- **Ralph Loop TDD** — Red → Check → Green → Mutation → Refactor
- **5-Level Anti-Drift** — Confirm gates, micro-tasks, circuit breaker, static checks, mutation review
- **Constitution + Hooks** — 9 articles enforced by Pre/Post ToolUse hooks with waiver system
- **Skill Graph Engine** — DAG visualization, orchestration, scheduling and tracking
- **22 AI Engine Support** — 4-tier compatibility (Claude Code, Cursor, Copilot, etc.)
- **Cross-Model Delegation** — Automatic model degradation on consecutive failures
...
|----------|-------------|
| [Installation](./INSTALL.md) | Setup and requirements |
| [Usage](./USAGE.md) | Complete usage guide |
| [Architecture](./ARCHITECTURE.md) | System architecture |
| [Examples](./EXAMPLES.md) | Community examples |
| [CLI Guide](./docs/en/cli-guide.md) | CLI reference (EN) |
| [Getting Started](./docs/en/getting-started.md) | Quick start (EN) |
